...
log_replacements = {
  ...
  'Starting service wazuh-indexer.': 'Starting service soc-indexer.',
  'wazuh-indexer service started.': 'soc-indexer service started.',
  'Starting service wazuh-manager.': 'Starting service soc-manager.',
  'wazuh-manager service started.': 'soc-manager service started.',
  'Starting service wazuh-dashboard.': 'Starting service soc-dashboard.',
  'wazuh-dashboard service started.': 'soc-dashboard service started.',
