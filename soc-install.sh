...
function getHelp() {
    ...
    echo -e "                Path to the configuration file used to generate soc-install-files.tar file containing the files that will be needed for installation. By default, the Wazuh installation assistant will search for a file named config.yml in the same path as the script."
    echo -e ""
    ...
    echo -e "                Generate soc-install-files.tar file containing the files that will be needed for installation from config.yml. In distributed deployments you will need to copy this file to all hosts."
    echo -e ""
    echo -e "        -h,  --help"
    ...
    echo -e "                Path to tar file containing certificate files. By default, the Wazuh installation assistant will search for a file named soc-install-files.tar in the same path as the script."
    echo -e ""
    echo -e "        -u,  --uninstall"
...
function main() {
    ...
    common_logger "Starting SOC installer. SOC baseline (Wazuh) version: ${wazuh_version}"
    common_logger "Verbose logging redirected to ${logfile}"
    common_logger "Practikal IT Solutions | Security Operations & IT Audit Centre"
